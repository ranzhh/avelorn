...
<!-- screenshot slot: the battle table mid-fight — two blocks engaged, the resolved dock showing the distributions.
![The battle table](docs/screenshots/table.png) -->
...
<!-- screenshot slot: a datasheet pane over the table, a weapon pane cascaded off it.
![Floating panes](docs/screenshots/panes.png) -->
