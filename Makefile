...
types-check: ## fail if the committed types no longer match the Pydantic models
	uv run python scripts/dump_openapi.py frontend/openapi.json
	cd frontend && npx openapi-typescript openapi.json -o src/lib/api/schema.d.ts --check
